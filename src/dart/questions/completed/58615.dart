...
h(){print(List.generate(100,(i)=>(i%3>0?'':'Fizz')+(i%5>0?(i%3>0?'$i':''):'Buzz')).join('\n'));}
g(){List.generate(100,(i)=>(i%3>0?'':'Fizz')+(i%5>0?(i%3>0?'$i':''):'Buzz')).forEach(print);}
j({i=0}){for(;i++<100;){var a=i%3>0;print((a?'':'Fizz')+(i%5>0?(a?'$i':''):'Buzz'));}}
f({i=0}){for(;i++<100;)print((i%3>0?'':'Fizz')+(i%5>0?(i%3>0?'$i':''):'Buzz'));}
k({i=0}){for(;i++<100;)print("${i%3>0?'':'Fizz'}${i%5>0?(i%3>0?i:''):'Buzz'}");}
l({i=0}){for(;i++<100;)print(i%15<1?'FizzBuzz':i%5<1?'Buzz':i%3<1?'Fizz':'$i');}
